...
if [[ $1 == "en" ]]; then
	...
	if [[ $2 == "RC4" ]]; then
		openssl enc -rc4 -in "$4" -out "$5" -base64 -A -K "$3" -iv "00000000000000000000000000000000"
		#statements
	fi
	# if [[ $2=="" ]]; then
	# 	#statements
	...
	if [[ $2 == "RC4" ]]; then
		openssl enc -d -rc4 -in "$4" -out "$5" -base64 -A -K "$3" -iv "00000000000000000000000000000000"
		#statements
	fi
fi
